...
namespace BjornsRadioExcelExport.Controllers
{
    public class SongsController : Controller
    {
        ...
        {
            ViewData["Album"] = new SelectList(_context.Albums, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Album,AlbumOrder,Title,Comments")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Album,AlbumOrder,Title,Comments")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
